//
// Created by sudo-panda on 3/25/20.
//
// Modifies version of
//

#ifndef BENCHMARKBGWKT_INCLUDE_WRITE_HPP_
#define BENCHMARKBGWKT_INCLUDE_WRITE_HPP_
...
struct wkt_range
{
 ...
 private:
  ...
  static inline bool disjoint(point_type const& p1, point_type const& p2)
  {
    ...
    return boost::geometry::detail::disjoint::disjoint_point_point(p1, p2, strategy_type());
  }
};
...
struct wkt_poly
{
                           ...
                           int significant_digits, bool force_closure)
  {
    ...
    for (typename boost::geometry::detail::interior_iterator<Polygon const>::type
...
struct wkt<Point, point_tag>
    : detail::wkt::wkt_point
          <
              Point,
              boost::geometry::detail::wkt::prefix_point
          >
{};
...
struct wkt<Polygon, polygon_tag>
    : detail::wkt::wkt_poly
          <
              Polygon,
              boost::geometry::detail::wkt::prefix_polygon
          >
{};
          ...
          <
              ...
              detail::wkt::wkt_point
                  <
                      ...
                      boost::geometry::detail::wkt::prefix_null
                  >,
              boost::geometry::detail::wkt::prefix_multipoint
          >
{};
          ...
          <
              ...
              detail::wkt::wkt_sequence
                  <
                      ...
                      false
                  >,
              boost::geometry::detail::wkt::prefix_multilinestring
          >
{};
          ...
          <
              ...
              detail::wkt::wkt_poly
                  <
                      ...
                      boost::geometry::detail::wkt::prefix_null
                  >,
              boost::geometry::detail::wkt::prefix_multipolygon
          >
{};
...
#endif //BENCHMARKBGWKT_INCLUDE_WRITE_HPP_
